    ...
    private void printSandboxHelp() {
        ...
        if (isEs) {
            ...
            postOutput("======================================================\n"
                    ...
                    + "  help / ?                Display this sandbox help\n\n"
                    + "======================================================\n"
                    + "  REAL NATIVE BINARY EXECUTION (MORIA)\n"
                    + "======================================================\n"
                    + "From the bottom command input, you can directly run\n"
                    + "the real native binary with any command or option:\n\n"
                    + "  moria [options] <file|dir>\n\n"
                    + "EXAMPLES:\n"
                    + "  moria firmware.bin          Identify firmware structures\n"
                    + "  moria -e firmware.bin       Extract filesystems and archives\n"
                    + "  moria -c firmware.bin       Carve raw byte streams\n"
                    + "  moria -A firmware.bin       Full deep analysis\n"
                    + "  moria -E firmware.bin       Entropy analysis pass\n"
                    + "  moria --list firmware.bin   List archive contents without extraction\n"
                    + "  moria -e file.bin | grep sq Shell pipes and filters\n\n"
                    + "To view full native help for the Moria binary, run:\n"
                    + "  moria --help\n"
                    + "======================================================\n");
        }
    }
